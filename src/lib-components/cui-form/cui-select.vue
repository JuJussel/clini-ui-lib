<template>
    <div class="cui-select-container" v-bind:class="{ disabled }" @click.stop="handleClick">
        ...
        <div ref="select" class="cui-select" v-bind:class="{ focused: focused, 'has-color': color, disabled: disabled }"
            ...
            <div v-else>
                <div v-if="search && !multiple">
                    <input ref="input" class="cui-select-input" v-model="searchValue" @click.stop="" @input="searchInput"
            ...
            <div>
                <i class="cui-select-icon fas fa-chevron-down" v-bind:class="{ focused: focused }"></i>
            </div>
        </div>
        <div ref="dropdown" class="cui-select-list" v-bind:class="{
            expanded: focused,
            ...
            <div v-if="data.length > 0">
                <div class="cui-select-dropdown-item" v-for="(item, index) in dropdownValues" :key="index"
